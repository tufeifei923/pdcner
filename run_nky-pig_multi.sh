CUDA_VISIBLE_DEVICES=1,2,3,4 python3 -m torch.distributed.launch --master_port 13517 --nproc_per_node=4 \
       pdcner_trainer.py --do_train --do_eval --do_predict --evaluate_during_training \
                  --data_dir="data/dataset/NER/nky-pig" \
                  --output_dir="data/result/NER/nky-pig/lebertcrf_20240408" \
